...
$fecha=date("Y-m-d");
$addNewVenta="INSERT INTO `ventas`(`fechaV`, `totalV`, `idUser`,estado) VALUES (:fecha,:total,:idUser,'PAGADO')";
...
foreach ($productos as $key) {
    $sqlInsetDetailVenta="INSERT INTO `detalleventa`(`idV`, `nombreProducto`, `cantidadV`, `precio`, `fecha`,idArticulo,estado)
                        VALUES (:idVenta,:nombre,:cantidadV,:precio,:fecha,:idArticulo,'PAGADO')";
