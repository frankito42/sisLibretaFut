...
async function cargarProductoTablaVenta(codi,idPro) {
    ...
    if(codigo){
        ...
        .then(async(data)=> {
            await cargarClientes()
            toastr.success('Se añadio un producto!', 'Exito.')
            console.log(data)
                ...
                <div onclick="abrirModalProductos(${data[index].idVenta},event)" class="col-md-4">
                    <div style="margin-bottom: 3%;" class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h6 style="font-weight: bold;background: #33b5e5;PADDING: 2%;border-radius: 5px;color: white;" class="card-title">user: ${data[index].user}</h6>
                                </div>
                                <div class="col">
